	...
	<body>
		...
		<nav id="Content"> <!-- 본문, 각 조원들이 넣게될 본문 레이아웃 생성 -->
			<div style="width:770px; background: white; padding-top: 5em; padding-left: 7em; background-clip: content-box;">
				<h3>공지사항 세부내용</h3>
				<!-- 수정할때 변경할 각 내용들 입력받는 페이지 -->
				<hr color = "blue">
					<form action="BoardChange.jsp">
					제목 : <input name = "title"><br>
					첨부파일 : <input name = "file"><br>
					내용 : <br>
				...
				<!-- 	<form action="bbs삭제.jsp">
					<button>삭제하기</button>
					</form> 나중에 javascript로 하기!-->
				
				<a href="ServiceMain.jsp">
					<button>공지사항으로</button> <!-- 수정하지 않으면 다시 돌아가기 -->
				</a>
			</div>
		</nav> <!-- 본문 닫음 -->
	</body>
