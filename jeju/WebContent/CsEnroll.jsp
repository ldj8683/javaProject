...
<!DOCTYPE html>
<!-- 등록하기 페이지! 각 요소를 입력받아 정보를 저장하는 페이지! -->
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<nav id="Content" style=""> <!-- 본문, 각 조원들이 넣게될 본문 레이아웃 생성 -->
			<div style="width:770px; background: white; padding-top: 5em; padding-left: 7em; background-clip: content-box;">
				...
				<!-- 고객의 소리 등록시 입력값 받는 곳 -->
				<hr color="black">
				<form action="CsEnrollSubmit.jsp">
				...
				업체명 : <input name = "customer_accommdation_name"><br>
				날짜 : <input name = "customer_date"><br>
				작성자 : <input name = "customer_writer"><br>
				내용 : <br>
