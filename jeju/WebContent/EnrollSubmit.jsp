...
notice_board nb = new notice_board();  // create 메서드 사용을 위한 new(틀) 만들기!
nb.create(title, date, writer, file, content); // 메서드 사용!
%>
...
<html>
	...
	<body>
		...
		<nav id="Content"> <!-- 본문, 각 조원들이 넣게될 본문 레이아웃 생성 -->
			등록이 완료되었습니다.<br><br>
			<form action="ServiceMain.jsp"><!-- 등록완료 후 돌아가기 -->
				<button>돌아가기</button>
			</form>
		</nav> <!-- 본문 닫음 -->
	</body>
