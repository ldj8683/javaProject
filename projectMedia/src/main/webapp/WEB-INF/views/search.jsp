...
<div class="container">
			<div class="item">									
				...
				<div class="item">									
						<c:forEach var="vo" items="${list}" begin="1" end="1">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="1" end="1">	
				...
				<div class="item">									
						<c:forEach var="vo" items="${list}" begin="2" end="2">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="2" end="2">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="3" end="3">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="3" end="3">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="4" end="4">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="4" end="4">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="5" end="5">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="5" end="5">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="6" end="6">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="6" end="6">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="7" end="7">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="7" end="7">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="8" end="8">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="8" end="8">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="9" end="9">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="9" end="9">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="10" end="10">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="10" end="10">	
			...
			<div class="item">									
						<c:forEach var="vo" items="${list}" begin="11" end="11">	
						 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
							</c:forEach>
							<div class="details">
							<c:forEach var="vo" items="${list}" begin="11" end="11">	
