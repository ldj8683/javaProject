...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<h3>장바구니 상품 삭제</h3>
		<hr color="red">
		<form action="cartDelete4">
		<table>	
			<tr><td>번호: <input type="text" name="cnumber" readonly></td></tr>
			<tr><td>아이디: <input type="text" name="userid"></td></tr>
			<tr><td>상품: <input type="text" name="cproduct"></td></tr>
			<tr><td>코드: <input type="text" name="ccode" readonly></td></tr>
			<tr><td>수량: <input type="text" name="cquantity" readonly></td></tr>
			<tr><td>금액: <input type="text" name="cpayment" readonly></td></tr>
		</table>
		<br>		
  		<input type="submit" value="장바구니 상품삭제">
		</form>
		</div>
	</body>
</html>