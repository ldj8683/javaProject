...
<html style="margin: 0px">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="resources/css/out1.css" >
	...
	<div id="content">
		<div id="char">시청기록</div><br>	
			<div class="container">
				<div class="item">															
							<c:forEach var="vo" items="${list1}" begin="0" end="0">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list1}" begin="0" end="0">	
									<h4>${vo.title}</h4>
									<p>${vo.vdate1}</p>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list1}" begin="1" end="1">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list1}" begin="1" end="1">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list1}" begin="2" end="2">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list1}" begin="2" end="2">	
									<h4>${vo.title}</h4>
			...
			<div class="container">				
				<div class="item">												
							<c:forEach var="vo" items="${list2}" begin="0" end="0">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list2}" begin="3" end="3">	
									<h4>${vo.title}</h4>
									<p>${vo.vdate1}</p>
									<p>${vo.clicks}회</p>
									</c:forEach>																	
				...
				<div class="item">												
							<c:forEach var="vo" items="${list2}" begin="1" end="1">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list2}" begin="1" end="1">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list2}" begin="2" end="2">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list2}" begin="2" end="2">	
									<h4>${vo.title}</h4>
			...
			<div id="char1">나중에 볼 동영상</div><br>	
			 <div class="container">				
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="0" end="0">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="0" end="0">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="1" end="1">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="1" end="1">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="2" end="2">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="2" end="2">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="3" end="3">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="3" end="3">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="4" end="4">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="4" end="4">	
									<h4>${vo.title}</h4>
				...
				<div class="item">												
							<c:forEach var="vo" items="${list3}" begin="5" end="5">	
							 <a href=select?vnum=${vo.vnum}&userid=<%=loginId%>><img src="${vo.image}" class="thumb" ></a><br>
								</c:forEach>							
								<c:forEach var="vo" items="${list3}" begin="5" end="5">	
									<h4>${vo.title}</h4>
